                        ...
                        when (it) {
                            ...
                            is KtNameReferenceExpression -> {
                                ...
                                it.parent !is KtThisExpression &&
                                        it.getQualifiedExpressionForSelector() == null &&
                                        (it.parent as? KtElement)?.getQualifiedExpressionForSelector() == null &&
                                        resolvedCall != null &&
                                        descriptor?.extensionReceiverParameter?.type?.isMarkedNullable != true &&
                            ...
                            is KtBinaryExpression -> {
                                it.operationToken != KtTokens.EQEQ &&
                                        ...
                                        (it.left is KtThisExpression || it.right is KtThisExpression)
                            }
                            else -> false
                        }
                    }) return
